...
<body>
    ...
    <main>
        ...
        <h1 class="vibrate-1">Vous souhaitez nous rejoindre ?</h1>
        <article class="margin-bot-40 margin-bot-md-80">
            ...
            <p>Tu as pu désormais t’apercevoir de la formidable puissance que les Greens peuvent déployer. Malgré tous ces incroyables pouvoirs, ils ne possèdent pas pour autant le don d’ubiquité… 1 paire de bras supplémentaire ne sera pas de trop pour réaliser toutes les missions auxquelles les Greens sont confrontées ! Si tu es capable de surmonter tes peurs et que tu as 1 esprit de battant, c’est que tu es digne de porter 1 de nos anneaux de pouvoir !
            </p>
        </article>

        <form class="margin-bot-40 margin-bot-md-80" name="contact">
            <h1 class="vibrate-1">Formulaire de contact</h1>  
